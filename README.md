# Xijum-AEGIS Weapon System - v0.0.8

“Powered by Xijum AEGIS Weapon System”
“AEGIS v1.0 – Modular Combat Framework”
...
```bash
rojo build -o "Xijum-AEGIS.rbxlx"
```

Next, open `Xijum-AEGIS.rbxlx` in Roblox Studio and start the Rojo server:
